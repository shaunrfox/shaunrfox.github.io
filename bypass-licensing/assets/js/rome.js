...
},{"./isInput":25,"./momentum":26,"./parse":28}],20:[function(_dereq_,module,exports){
'use strict';
...
function inputCalendar (input, calendarOptions) {
  ...
  function position () {
    ...
    api.container.style.top  = '40px';
    api.container.style.left = '0px';
  }
