...
function onPageLoad()
{
    ...
    fixupAllIEPNGBGs();
    fixupIEPNG("id8", "nature_files/transparent.gif");
    fixupIEPNG("id15", "nature_files/transparent.gif");
    fixupIEPNG("id16", "nature_files/transparent.gif");
    fixupIEPNG("id17", "nature_files/transparent.gif");
    fixupIEPNG("id18", "nature_files/transparent.gif");
    fixupIEPNG("id19", "nature_files/transparent.gif");
    fixupIEPNG("id20", "nature_files/transparent.gif");
    fixupIEPNG("id21", "nature_files/transparent.gif");
    fixupIEPNG("id22", "nature_files/transparent.gif");
    fixupIEPNG("id23", "nature_files/transparent.gif");
    fixupIEPNG("id24", "nature_files/transparent.gif");
    fixupIEPNG("id25", "nature_files/transparent.gif");
    fixupIEPNG("id26", "nature_files/transparent.gif");
    return true;
}
