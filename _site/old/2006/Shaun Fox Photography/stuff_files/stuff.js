...
function onPageLoad()
{
    ...
    fixupAllIEPNGBGs();
    fixupIEPNG("id2", "stuff_files/transparent.gif");
    fixupIEPNG("id3", "stuff_files/transparent.gif");
    fixupIEPNG("id4", "stuff_files/transparent.gif");
    fixupIEPNG("id5", "stuff_files/transparent.gif");
    fixupIEPNG("id6", "stuff_files/transparent.gif");
    fixupIEPNG("id7", "stuff_files/transparent.gif");
    fixupIEPNG("id8", "stuff_files/transparent.gif");
    fixupIEPNG("id9", "stuff_files/transparent.gif");
    fixupIEPNG("id10", "stuff_files/transparent.gif");
    fixupIEPNG("id11", "stuff_files/transparent.gif");
    fixupIEPNG("id12", "stuff_files/transparent.gif");
    fixupIEPNG("id13", "stuff_files/transparent.gif");
    fixupIEPNG("id14", "stuff_files/transparent.gif");
    return true;
}
